...
<html lang="en">
    ...
    <body class="btn-rounded">
		...
		<div class="nav-container"><nav>
		        ...
		        <div class="nav-bar text-center">
		            <div class="col-md-2 col-md-push-5 col-sm-12 text-center">
		                <a href="#">
		                    <div class="vnu"><img alt="logo" class="image-xxs" src="img/kironventureslogo3.png"></div>
		                </a>
		            </div>
		        ...
		        <div class="container">
		            <div class="row">
		                <div class="col-sm-12 text-center">
		                    <h2 class="mb16">How do we support our Startups</h2>
		                    <p class="lead mb64">
		                        It is all about providing the tools to be able to execute and generate a social impact.
		                    </p>
		                </div>
		            </div>
		                ...
		                <div class="col-sm-3">
		                    <div class="feature feature-1 boxed">
		                        <div class="text-center">
		                            ...
		                            <h5 class="uppercase">Mentoring</h5>
		                        </div>
		                        <p>
		...
		We will provide the technical skills that you are missing in your team, our network of motivated designers, developers and engineers are willing to help and partner with you.
		                    ...
		                    <div class="feature feature-1 boxed">
		                        <div class="text-center">
		                            <i class="icon pe-7s-light"></i>
		                            <h5 class="uppercase">CO-WORKING SPACE</h5>
		                        </div>
		...
		-	Advice for experts in the market.
		        ...
		        <div class="container">
		            <div class="row">
		                <div class="col-sm-6 col-md-3">
		                    <div class="image-tile outer-title text-center">
		                        <img alt="Pic" src="img/Vincent-Zimmer.jpg">
		                ...
		                <div class="col-sm-6 col-md-3">
		                    <div class="image-tile outer-title text-center">
		                        <img alt="Pic" src="img/Foundfair_2015_Katharina.jpg">
		                        <div class="title mb16">
		                            <h5 class="uppercase mb0">Katharina Dermühl&nbsp;</h5>
		                ...
		                <div class="col-sm-6 col-md-3">
		                    <div class="image-tile outer-title text-center">
		                        <img alt="Pic" src="img/Juan-David-Mendieta.jpg">
		                        <div class="title mb16">
		            ...
		            <div class="background-image-holder">
		                <img alt="image" class="background-image" src="img/home-4-1.jpg">
		            </div>
		            <div class="container">
		                <div class="row mb40 mb-xs-24">
		                    <div class="col-sm-12 text-center">
		                        <h3 class="mb8">Subscribe for a monthly roundup of best Social-impact start-ups.</h3>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-4">
							<a href="#"><img class="image-xxs fade-half" alt="Pic" src="img/kironventureslogo4.png"></a>
						</div>

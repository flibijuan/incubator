...
<html lang="en">
    <head>
         <title>Kiron Ventures | Context </title>
		            ...
		            <div class="row">
		                <div class="col-sm-4 text-center">
		                    <div class="feature boxed cast-shadow-light">
		                        <img alt="Pic" class="image-small inline-block mb24" src="img/RORE.png">
		                        <h4>"Refugee code school "</h4>
		                        <p>
		                            fantastic solution for integration of refugees in society by giving them one the most required skills by employees<br>
		</p>
		                        <span> </span>
		                    </div>
		                </div>
		                <div class="col-sm-4 text-center">
		                    <div class="feature boxed cast-shadow-light">
		                        <img alt="Pic" class="image-small inline-block mb24" src="img/RW.png">
		                        <h4>"Flat sharing for refugees"</h4>
		                        <p>
		                            Why shouldn't refugees in your country be able to live in shared flats,&nbsp;instead of mass accommodation?<br></p>
		                        <span> </span>
		                    </div>
		                </div>
		                <div class="col-sm-4 text-center">
		                    <div class="feature boxed cast-shadow-light">
		                        <img alt="Pic" class="image-small inline-block mb24" src="img/cucula.png">
		                        <h4>"Cucula ,Craft and Designs"</h4>
		                        <p>
		                            CUCULA is an association, a workshop and an educational program all in one. It is for and together with refugees in Berlin.<br>
		                        </p>
		                        <span> </span>
		                    </div>
		                </div><div class="col-sm-4 text-center">
		                    <div class="feature boxed cast-shadow-light">
		                        <img alt="Pic" class="image-small inline-block mb24" src="img/RE.png">
		                        <h4 src="img/RE.png" alt="Pic">"Crowdfunding for refugees"</h4>

		                        <span>
		                            We are working here on a Platform which features Crowdfunding Projects from Refugees in Germany.<br><br>
		                        </span>
		                    </div>
		                </div><div class="col-sm-4 text-center">
		                    <div class="feature boxed cast-shadow-light">
		                        <img alt="Pic" class="image-small inline-block mb24" src="img/W3W.png">
		                        <h4 src="img/W3W.png" alt="Pic">"The simplest way to communicate location"</h4>

		                        <span>&nbsp;A global grid of 57 trillion 3mx3m squares.<br>Each square has a 3 word address that can be communicated quickly, easily and no ambiguity.<br><br>
		                        </span>
		                    </div>
		                </div><div class="col-sm-4 text-center">
		                    <div class="feature boxed cast-shadow-light">
